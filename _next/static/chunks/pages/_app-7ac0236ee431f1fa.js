 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rI=new t_(tf.comparator),rC=new t_(tf.comparator);function rA(...e){let t=rC;for(let r of e)t=t.insert(r.key,r);return t}function rD(){return new rS(e=>e.toString(),(e,t)=>e.isEqual(t))}new t_(tf.comparator);let rN=new tC(tf.comparator);function rk(...e){let t=rN;for(let r of e)t=t.add(r);return t}let rL=new tC(ti);/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
